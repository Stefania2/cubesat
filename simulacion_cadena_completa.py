...
# Title: Cadena Completa BPSK - CubeSat STRaND-1
# Author: Mayelin Stefania Aguilar Vasquez
# Description: Cadena completa de transmision y recepcion BPSK con telemetria real STRaND-1.
...
class simulacion_cadena_completa(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Cadena Completa BPSK - CubeSat STRaND-1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Cadena Completa BPSK - CubeSat STRaND-1")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "simulacion_cadena_completa")
        ...
        self._noise_amplitude_range = qtgui.Range(0.0, 0.5, 0.01, 0.05, 200)
        self._noise_amplitude_win = qtgui.RangeWidget(self._noise_amplitude_range, self.set_noise_amplitude, "Amplitud de ruido AWGN", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_time_sink_x_2.set_y_axis(-0.5, 1.5)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_2_win, 1, 2, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_0.set_y_label('Espectro', 'dB')
        ...
        self.qtgui_const_sink_x_0.set_y_axis((-2.0), 2.0)
        self.qtgui_const_sink_x_0.set_x_axis((-2.0), 2.0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_integrate_ff_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_integrate_ff_0, 0), (self.digital_binary_slicer_fb_0, 0))
        self.connect((self.blocks_integrate_ff_0, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.blocks_null_sink_0, 0))
...
def main(top_block_cls=simulacion_cadena_completa, options=None):
